...
- **Regression** → predicting a **number** 🔢
  ::: {.example-line}
  house price, tomorrow's temperature, calories burned in a workout
  :::
- **Classification** → predicting a **category** 🏷️
  ::: {.example-line}
  spam or not, cat or dog, edible or poisonous
  :::
:::
...
::: {.fragment .quiz}
Why square the errors instead of just averaging them directly?<br>
...
::: {.fragment .quiz}
Today's lab: a model that decides whether a mushroom is edible or poisonous. 🍄<br>
Which mistake is worse, calling a poisonous mushroom "edible", or calling an edible one "poisonous"?<br>
Which metric should you obsess over?
:::
...
::: {.fragment .quiz}
Model A: 98% training accuracy, 65% test accuracy.<br>
Model B: 85% training accuracy, 83% test accuracy.<br>
